...
bookForm.addEventListener("click", () => {
	...
	document.querySelector("#bookform").style.backgroundColor = "rgba(0,0,0,.7)";
	// document.querySelector("#bookform").style.transform = "translate(23% 20%)";
});
...
const navLinks = document.querySelectorAll(".heder__nav-link");
